...
import { For, Setter, Show, createEffect, createSignal, on, onCleanup, onMount, splitProps } from 'solid-js';
...
import { In, LineData, Te_IOstate, createCommandHistory, createSubmitHandler, setup_history_events, setup_socket_events } from "./console.utils";
                ...
                >
                 ...
                 <div class="flex-grow"
                    ...
                    <Line 
                        ...
                        set_msg_ref={setter => update_command_from_history = setter}
                        />
