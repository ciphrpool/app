...
const syntax = {
    ...
    keywords: [
        "enum","struct","union","as",
        "return","let","break","continue","move","rec","dyn",
        "fn", "true", "false"
    ],
    control: [
        "else","try","if","then","match","case",
        "while","for","loop"
    ],
    typeKeywords: [
        "u8","u16","u32","u64","u128","i8","i16","i32","i64","i128",
        "f64","char","String","str","bool","unit","Any","Unit","error",
        "Vec","Map","RangeI","RangeE"
    ],
